...
collisionFileID = [savePath, 'L4_P1_connections_', runID]; % filename to save collision data
%% ================================================== SET RUN PARAMETERS  ==================================================
...
initialStableArc = [pi/2, pi/2]; % [midPoint, arcRadius] for initial on P1 collision manifold. [pi/2, pi/2] parameterizes only a half circle
