function cData = fix_connection2BVP(connectionData, nNode, stableLocalMap, unstableLocalMap)

%FIX_CONNECTION2BVP - One line description of what the script performs (H1 line)
%   Fix problems with connection2BVP and implement the Connnection class properly.
%
%   Description:
%       FIX_CONNECTION2BVP description
%
%   Output:
%       FIX_CONNECTION2BVP output
%
%   Subfunctions: none
