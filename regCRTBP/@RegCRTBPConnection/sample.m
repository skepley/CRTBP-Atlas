function sampleData = sample(obj, nNode)
...
globalTime = linspace(0, obj.ConnectionTime, nNode); % a uniform grid of global F0 time points along the entire connecting orbit
...
unstableData = sample_connection_from_unstable(obj.UnstableChart, obj.GlobalIntersection(3:4), globalTime);
